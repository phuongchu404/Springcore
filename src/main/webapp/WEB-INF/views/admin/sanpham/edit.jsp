					...
					<form action="/sanpham/save" method="post">
								...
								<select class="form-control" id="loaiSPs" name="loaiSPs">
									<c:forEach var="item" items="${loaiSP}">
										<option value="${item.maLoaiSP}"
											<c:if test="${item.maLoaiSP == maloaiSP}">selected="selected"</c:if>>${item.tenLoaiSP}</option>
									</c:forEach>
								</select>
							</tr>
						</div>
						...
						<div alight="left">
							<tr>
								...
								<td><input type="text" name="tenSP" class="form-control"
									placeholder="Tên sản phẩm" value="${sanpham.tenSP }" /></td>
							</tr>
						</div>
						...
						<div alight="left">
							<tr>
								...
								<td><input type="text" name="moTa" class="form-control"
									placeholder="Mô tả" value="${sanpham.moTa }" /></td>
							</tr>
						</div>
						...
						<div alight="left">
							<tr>
								...
								<td><input type="text" name="donGia" class="form-control"
									placeholder="đơn giá" value="${sanpham.donGia }" /></td>
							</tr>
						</div>
						...
						<div alight="left">
							<tr>
								...
								<td><input type="text" name="soLuong" class="form-control"
									placeholder="số lượng" value="${sanpham.soLuong }" /></td>
							</tr>
						</div>
